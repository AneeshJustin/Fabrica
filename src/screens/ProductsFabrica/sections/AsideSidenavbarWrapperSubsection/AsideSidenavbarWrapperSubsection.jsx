...
const navigationItems = [
    { label: "Dashboard", icon: LayoutGridIcon, path: "/dashboard-home-u45-fabrica-admin" },
    { label: "Products", icon: Package2Icon, path: "/products-u45-fabrica-admin" },
    ...
    { label: "Analytics", icon: BarChart3Icon, path: "/analytics-u45-fabrica-admin" },
    { label: "Discounts", icon: BadgePercentIcon, path: "/discounts-u45-fabrica-admin" },
                        ...
                        return (
                            <li key={item.label} className="w-full">
                                <Button
                                    ...
                                    className={`h-auto w-full justify-start gap-3 rounded-lg px-4 py-2.5 hover:bg-zinc-100 ${isActive
