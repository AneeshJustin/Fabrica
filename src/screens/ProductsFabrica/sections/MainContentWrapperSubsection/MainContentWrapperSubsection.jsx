            ...
            >
              ...
              {[1, 2, 3].map((page) => (
                <Button
                  key={page}
                  variant="ghost"
                  className={`h-8 w-8 rounded-lg p-0 [font-family:'Manrope',Helvetica] text-xs font-semibold leading-[14.4px] tracking-[0] ${
                    currentPage === page
            ...
            <CardContent className="flex h-[98px] items-center justify-between gap-4 p-6">
              <div className="flex items-center gap-4">
                ...
                <div className="inline-flex flex-col items-start">
                  <div
                    className={`mt-[-1.00px] flex h-4 items-center whitespace-nowrap [font-family:'Manrope',Helvetica] text-xs font-medium leading-4 tracking-[0] ${
                      card.dark ? 'text-zinc-400' : 'text-zinc-500'
                    }`}
                  >
                    {card.label}
                  </div>
                  <div
                    className={`mt-[-1.00px] flex h-8 items-center whitespace-nowrap [font-family:'Manrope',Helvetica] text-2xl font-semibold leading-[31.2px] tracking-[0] ${
