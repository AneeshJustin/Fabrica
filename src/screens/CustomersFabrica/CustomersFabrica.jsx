...
const customerStats = [
    { label: "Total Customers", value: "8,429", change: "+12.5%", positive: true },
    { label: "Active Members", value: "6,234", change: "+8.2%", positive: true },
    { label: "Average Order Value", value: "$154.20", change: "-2.4%", positive: false },
    { label: "New Registrations", value: "842", change: "+18.7%", positive: true },
];
                                        ...
                                        <CardContent className="p-6">
                                            <div className="flex items-start justify-between">
                                                ...
                                                <div className={`flex items-center gap-1 text-xs font-medium ${
                                                    ...
                                                    {stat.positive ? <TrendingUpIcon className="h-3 w-3" /> : <TrendingDownIcon className="h-3 w-3" />}
                                                    {stat.change}
                                                </div>
                                            </div>
                                        </CardContent>
                                ...
                                <Card className="rounded-xl border-[#e6e6e6] bg-white shadow-none">
                                    <CardContent className="p-6">
                                        ...
                                        <div className="h-48 bg-[#f3f3f4] rounded-lg flex items-center justify-center">
                                            <p className="text-[#444748]">Customer retention visualization</p>
                                        </div>
                                    </CardContent>
                                </Card>
                                ...
                                <Card className="rounded-xl border-[#e6e6e6] bg-white shadow-none">
                                    <CardContent className="p-6">
                                        ...
                                        <div className="space-y-4">
                                            <div className="flex items-center justify-between">
                                                <span className="text-sm text-[#444748]">VIP Customers</span>
                                                <div className="flex items-center gap-2">
                                            ...
                                            <div className="flex items-center justify-between">
                                                <span className="text-sm text-[#444748]">Regular Customers</span>
                                                <div className="flex items-center gap-2">
                                                    <div className="w-32 bg-zinc-200 rounded-full h-2">
                                            ...
                                            <div className="flex items-center justify-between">
                                                <span className="text-sm text-[#444748]">New Customers</span>
                                                <div className="flex items-center gap-2">
                                                    <div className="w-32 bg-zinc-200 rounded-full h-2">
