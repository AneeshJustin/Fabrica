                        ...
                        >
                            <CardContent className="flex flex-col gap-1 p-6">
                                <div className="flex items-start justify-between">
                                    ...
                                    <Badge
                                        variant="secondary"
                                        className={`h-auto rounded-full px-2 py-1 [font-family:'Manrope',Helvetica] text-xs font-bold leading-4 shadow-none ${card.changeType === "positive"
                            ...
                            <div className="flex flex-col gap-4">
                                <div className="flex h-[271px] items-end justify-center gap-4 px-4 pt-[27.11px]">
                                    {performanceBars.map((bar) => (
                                        <div
                                            key={bar.day}
                                            className={`w-full flex-1 rounded-t-[8px] ${bar.height} ${bar.active ? "bg-zinc-900" : "bg-zinc-100"
                                                }`}
                                        />
                                    ))}
                                </div>
                                ...
                                {recentOrders.map((order) => (
                                    <TableRow key={order.id} className="border-neutral-50">
                                        ...
                                        <TableCell className="px-8 py-[25.5px]">
                                            <Badge
                                                className={`h-auto rounded px-2 py-1 [font-family:'Manrope',Helvetica] text-[10px] font-bold leading-[normal] shadow-none ${order.statusType === "dark"
